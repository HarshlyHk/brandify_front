      ...
      {success ? (
        <div className=" h-screen flex items-center justify-center px-4 ">
          <div>
            ...
            <p className="text-sm text-gray-800 mb-2">
              Thank you for reaching out. We've received your return or exchange
              request.
            </p>
        ...
        <div className=" md:w-[600px] w-full mx-auto mt-16 p-8 rounded-[10px] ">
          ...
          <p className="text-sm text-gray-500 mb-8 text-center">
            Fill in the form below to submit a return or exchange request.
          </p>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div>
              ...
              <Select value={formData.type} onValueChange={handleTypeChange}>
                <SelectTrigger className="w-full border border-zinc-200 rounded-[5px] p-4 focus:ring-2 focus:ring-black focus:outline-none">
