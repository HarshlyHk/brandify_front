        ...
        {item?.outOfStock ? (
          ...
          <>
            ...
            <div className="flex flex-wrap items-center gap-2 mt-4">
              ...
              <div className="text-green-700 text-[7.5px] sm:text-[10px] w-fit font-semibold px-2 py-2 mb-2 bg-[#e2f6e2] rounded-[5px] flex items-center gap-2">
              ...
              {item?.isFastDelivery == true && (
                <div className="text-purple-700 text-[7.5px] sm:text-[10px] w-fit font-semibold px-2 py-2 mb-2 bg-[#f1e2f6] rounded-[5px] flex items-center gap-2">
